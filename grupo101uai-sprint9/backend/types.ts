...
export interface CostReview {
    id: string;
    bank: string;
    costRating: string;        // Calificación de costo (1-5)
    feeType: string[];         // Tipos de tarifas evaluadas
    affordabilityComment: string; // Comentario sobre asequibilidad
    date: string;
    comparisonComment?: string;   // Comentario opcional comparando con otros bancos
}
