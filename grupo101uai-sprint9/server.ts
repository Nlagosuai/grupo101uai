...
import { loadCostReviews } from "./backend/services/reviewService.ts";
...
console.log("Cargando evaluaciones de costos...");
await loadCostReviews();
console.log("Evaluaciones de costos cargadas.");
